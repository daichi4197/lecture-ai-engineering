...
st.set_page_config(page_title="メモアプリ", layout="centered")
st.title("シンプルメモアプリ")
...
# テキストエリアでメモ入力
st.text_area("ここにメモをどうぞ", key="memo", height=300)
...
# ダウンロードリンク（オプション）
st.download_button("⬇️ テキストとしてダウンロード", st.session_state.memo, file_name="memo.txt")
